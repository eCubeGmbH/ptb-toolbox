...
function niceFunction2(input1, input2) {
...
tools.add({
    ...
    tags: ["tag1", "tag2"],
    tests: () => {
        tools.expect(niceFunction2("hello", "world")).toBe('HELLO world');
        tools.expect(niceFunction2("Helping", "World")).toBe('HELPING world');
    }
})
